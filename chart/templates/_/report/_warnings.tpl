...
Usage:
{{ include "_.warnings.resources" (dict "sections" (list "path1" "path2") context $) }}
Example:
{{- include "_.warnings.resources" (dict "sections" (list "csiProvider.provider" "server" "volumePermissions" "") "context" $) }}
